...
const CONFIG = {
	...
	// Weather
	weatherKey: 'https://api.open-meteo.com/v1/forecast?latitude=55.0344&longitude=82.9434&hourly=temperature_2m&current=temperature_2m', // Write here your API Key
	weatherIcons: 'OneDark', // 'Onedark', 'Nord', 'Dark', 'White'
	weatherUnit: 'C', // 'F', 'C'
	language: 'en', // More languages in https://openweathermap.org/current#multi

	trackLocation: true, // If false or an error occurs, the app will use the lat/lon below
	defaultLatitude: '55.018803',
	defaultLongitude: '82.933952',
	...
	firstlistsContainer: [
		...
		},
		{
			...
			links: [
				...
				{
					name: '3xui panel',
					link: 'https://195.133.75.198:451313/fjuJHLYrzW/',
				},
			],
		},
	],
